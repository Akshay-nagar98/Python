...
def forgot_password(request):
	if request.method=="POST":
		try:
			...
			#url = "https://www.fast2ms.com/dev/bilkV2"
			#querystring = {"authorisation":"pZJukie3zClBXUVMTGgAWcStxYj4yOmFQ6LqID2P8H75vrns10Bs7fq6k0V2ZeDbSFOjILd1taJi9nQu","variables_values":otp,"route":"otp","numbers":mobile}
			#headers = {'cache-control': "no-cache"} 
			#response = requests.request("GET",url, headers=headers,params=querystring)
			#print(response.text)

			url = "https://www.fast2sms.com/dev/bulkV2"
			querystring = {"authorization":"pZJukie3zClBXUVMTGgAWcStxYj4yOmFQ6LqID2P8H75vrns10Bs7fq6k0V2ZeDbSFOjILd1taJi9nQu","message":"OTP "+otp,"language":"english","route":"q","numbers":mobile}
			headers = {'cache-control': "no-cache"}
			response = requests.request("GET", url, headers=headers, params=querystring)
			print(response.text)
			print("OTP : ",otp)
